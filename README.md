...
**Ваши данные остаются на вашей машине.** Паспорт, журнал и все проекции живут в вашем каталоге данных. У Symbiont нет сервера, аккаунта, телеметрии и собственных сторонних сервисов — сам он соединений не открывает.
