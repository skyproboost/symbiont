...
/**
 * Бюджет паспорта внутри промпта. Живёт здесь, а не у движка возвышения:
 * укладываются по нему ДВА промпта — аудита и независимой проверки, — и разойтись
 * им нельзя. Проверяющий, получивший паспорт короче, чем аудитор, судит по
 * меньшему материалу и обязан оправдывать всё подряд.
 */
